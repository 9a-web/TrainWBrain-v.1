...
_AI_QUESTIONS_SYSTEM = (
    ...
    "  • advanced: 1ПМ в базовых движениях (присед / жим / тяга — можно «не знаю»), травмы или ограничения, "
    "предпочитаемый сплит (full-body / верх-низ / PPL — или «на усмотрение ИИ»), любимые / нелюбимые упражнения, "
    "нужна ли кардио/условка внутри тренировок, режим питания (масса / поддержка / дефицит), "
    "качество восстановления (сон 7–9ч / меньше / хроническая усталость).\n"
