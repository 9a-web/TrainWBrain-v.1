...
_AI_SYSTEM_GEN = _AI_SYSTEM + (
    ...
    "Для силы используй волновую периодизацию в стиле Wendler 5/3/1 от тренировочного максимума: "
    "нед.1 → 65/75/85%×5; нед.2 → 70/80/90%×3; нед.3 → 75/85/95% по схеме 5/3/1; нед.4 → разгрузка 40–60%×5. "
    "Для гипертрофии — линейная прогрессия процентов или повторов (например 65→70→72.5→разгрузка).\n"
