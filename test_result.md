...
test_plan:
  current_focus:
    - "P7 Statistics collection per workout + detailed/exercise-progress/deviation/coach-gated stats"
    - "P2.1 Skip/missed/reschedule system + schedule adherence + streak modes + user settings"
  stuck_tasks: []
  test_all: false
