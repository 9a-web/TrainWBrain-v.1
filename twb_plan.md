...
| **P7** Подробная статистика подопечного (графики) | ⏳ Запланировано | экран аналитики подопечного у тренера: тоннаж по неделям, прогресс топ-весов по упражнениям, частота, completion/streak, adherence (план vs факт), распределение по группам — на recharts (§9.3, §5.9) |
